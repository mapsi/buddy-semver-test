...
final class MandateBrowser implements RequiresPermissions
{
    use ComparesPermissions;

    protected $client;
    protected $token;
    protected $reactAppId = 'mandate-browser';
    protected $reactTheme;
    protected $scriptUrl = 'https://www.lexology.com/embedded/app/mandate-browser?tk=';
    protected $appRootPath = '/tools/mandates';
