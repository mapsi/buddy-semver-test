...
final class QaTool implements RequiresPermissions
{
    use ComparesPermissions;

    protected $client;
    protected $token;
    protected $reactAppId = 'qatool';
    protected $reactTheme;
    protected $scriptUrl = 'https://www.lexology.com/embedded/app/qatool?tk=';
    protected $toolRoot = '';
    protected $appRootPath = '/tools/gtdt/tool';

    public function __construct(Service $client, Brand $brand)
    {
        $this->client = $client;
        $this->reactTheme = 'theme-' . $brand->machine_name;
    }
